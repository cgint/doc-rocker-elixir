defmodule DocRockerWeb do
  ...
  def controller do
    quote do
      ...
      use Gettext, backend: DocRockerWeb.Gettext
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: DocRockerWeb.Endpoint,
        router: DocRockerWeb.Router,
        statics: DocRockerWeb.static_paths()
    end
  end
